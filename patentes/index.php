...
$sql="SELECT TIPO_PATENTE FROM  `patentes` where TIPO_PATENTE is not null group by TIPO_PATENTE  ORDER BY TIPO_PATENTE ";
...
$sql="SELECT actividad2 FROM  `patentes` where actividad2 is not null group by actividad2  ORDER BY actividad2 ";
if(!$actividad2 = $db->query($sql)){
    die('Hay un error [' . $db->error . ']');
}
$row_actividad2 = $actividad2->fetch_assoc();  
...
<div class="container" style="margin: 5px !important">
    <div class="row">
        ...
        <div class="gtipo form-check form-switch form-check-inline">
          <input style="margin-left:5px !important" type="checkbox" name="tipo[]" value="<?php echo htmlspecialchars($row_tipo["TIPO_PATENTE"]);?>" id="<?php echo htmlspecialchars($row_tipo["TIPO_PATENTE"]);?>" class="chk form-check-input">
          <label for="<?php echo htmlspecialchars($row_tipo["TIPO_PATENTE"]);?>" class="form-check-label" style="border-width:0px !important"><?php echo htmlspecialchars($row_tipo["TIPO_PATENTE"]);?></label>
        </div>
        ...
        <div class="gtipo form-check form-switch form-check-inline">
          <input style="margin-left:5px !important" type="checkbox" name="actividad2[]" value="<?php echo htmlspecialchars($row_actividad2["actividad2"]);?>" id="<?php echo htmlspecialchars($row_actividad2["actividad2"]);?>" class="chk form-check-input">
          <label for="<?php echo htmlspecialchars($row_actividad2["actividad2"]);?>" class="form-check-label" style="border-width:0px !important"><?php echo htmlspecialchars($row_actividad2["actividad2"]);?></label>
        </div>

        <?php } while ( $row_actividad2 = $actividad2->fetch_assoc() ); ?>
        <!-- ------->
...
<div id="m5">
  ...
  <li style="text-align:left !important; margin-left:-20px; list-style-type:none; cursor:pointer">
    <div class="square" style="background-color:#FF5733"></div>ALCOHOLES
  </li>
  <li style="text-align:left !important; margin-left:-20px; list-style-type:none; cursor:pointer">
    <div class="square" style="background-color:#FFD700"></div>COMERCIALES
  </li>
  <li style="text-align:left !important; margin-left:-20px; list-style-type:none; cursor:pointer">
    <div class="square" style="background-color:#8B008B"></div>INDUSTRIALES
  </li>
  <li style="text-align:left !important; margin-left:-20px; list-style-type:none; cursor:pointer">
    <div class="square" style="background-color:#00CED1"></div>MICROEMPRESA FAMILIAR
  </li>
