...
// Fecha última actualización: 2025-09-19 12:07:52
// ************************************************************
...
<title>Lista de patentes comerciales</title>
...
$(document).ready(function() {
    ...
    var tabla = $('#tabla').DataTable({
        ...
        columnDefs: [
            ...
            { "targets": 1, visible: true, width: "5%" },
            { "targets": 2, visible: true, width: "17%" },
            { "targets": 3, visible: true, width: "27%" },
            { "targets": 4, visible: true, width: "27%" },
            { "targets": 5, visible: true, width: "27%" },
        ...
        "sAjaxSource": "api/patentes.php?token=" + token + "&task=list",
        "aoColumns": [
            { mData: mix },
            { mData: 'ROL' },
            { mData: 'RUT' },
            { mData: 'NOMBRE' },
            { mData: 'DIRECCION_COMERCIAL' },
            { mData: 'GIRO' },
            { mData: 'ROL_PROP' },
            { mData: 'TIPO_PATENTE' },
            { mData: 'LATITUD' },
    ...
    function agregarFiltroArea() {
        ...
        if ($("#filtroArea").length === 0) {
            $("#tabla_wrapper .top").prepend('<label>Giro: <select id="filtroArea"><option value="">Todos</option></select></label>');
        }

        // Llenar el dropdown después de que la tabla haya sido completamente cargada
        var areas = [];
        tabla.column(5).data().each(function(value) {
        ...
        $("#filtroArea").on("change", function() {
            ...
            tabla.column(5).search(valorSeleccionado).draw();
        });
    }
    ...
    function mix(data, type, dataToSet) {
        var link = '<a href="patentes_editar.php?patentes_id=' + data.id + '"><img src="img/document.png" width="32"></a>';
        return link;
    }
    ...
    <div id="page-content-wrapper">
        <div class="container-fluid p-4">
                ...
                <div class="row top-info-div">
                    ...
                    <button onclick="window.location='patentes_editar.php?patentes_id=0'" type="button" class="btn btn-primary"><i class="fa-solid fa-plus"></i>&nbsp;Nueva patente</button>
                    </div>                        
                </div>
                ...
                <div class="container mt-3">
                    ...
                    <table id="tabla" class="table display hoverable " style="width: 100% !important">
                        ...
                        <thead>
                            ...
                            <th style="width:17%">DIRECCION_COMERCIAL</th>
                            <th style="width:17%">GIRO</th>
                            </tr>
                        </thead>
