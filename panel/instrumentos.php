...
$(document).ready(function() {
    var tabla = $('#tabla').DataTable({
        ...
        "sAjaxSource": "api/instrumentos.php?token=" + $("#sid").val() + "&task=list",
        "aoColumns": [
            { mData: mix },
            { mData: 'instrumentos_descripcion' }
        ],
        "language": {
    ...
    function mix(data) {
        return '<a href="instrumentos_editar.php?instrumentos_id=' + data.instrumentos_id + '"><img src="img/document.png" width="32"></a>';
    }
});
</script>
</head>
        ...
        <div class="container-fluid p-4">
            ...
            <div class="row top-info-div">
                ...
                <div class="col text-end">
                    ...
                    <button onclick="window.location='instrumentos_editar.php?instrumentos_id=0'" type="button" class="btn btn-primary"><i class="fa-solid fa-plus"></i>&nbsp;Nuevo instrumento</button>
                </div>
            </div>
