...
<title>Lista de permissos de edificación</title>
...
$(document).ready(function() {
    ...
    var tabla = $('#tabla').DataTable({
        ...
        columnDefs: [
            ...
            { "targets": 6, visible: false, width: "10%" },
        ...
        "sAjaxSource": "api/permisos.php?token=" + token + "&task=list",
        "aoColumns": [
            { mData: mix },
            { mData: 'nombre' },
            { mData: 'direccion' },
    ...
    function agregarFiltroArea() {
        ...
        if ($("#filtroArea").length === 0) {
            $("#tabla_wrapper .top").prepend('<label>Destino: <select id="filtroArea"><option value="">Todos</option></select></label>');
        }
    ...
    function mix(data, type, dataToSet) {
        var link = '<a href="permisos_editar.php?permisos_id=' + data.id + '"><img src="img/document.png" width="32"></a>';
        return link;
    }
    ...
    <div id="page-content-wrapper">
        <div class="container-fluid p-4">
                ...
                <div class="row top-info-div">
                    ...
                    <button onclick="window.location='permisos_editar.php?permisos_id=0'" type="button" class="btn btn-primary"><i class="fa-solid fa-plus"></i>&nbsp;Nuevo permiso</button>
                    </div>                        
                </div>
                ...
                <div class="container mt-3">
                    ...
                    <table id="tabla" class="table display hoverable " style="width: 100% !important">
                        ...
                        <thead>
                            ...
                            <th style="width:17%">Localidad</th>
