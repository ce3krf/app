...
$(document).ready(function() {
    ...
    var tabla = $('#tabla').DataTable({
        ...
        "sAjaxSource": "api/procesos.php?token=" + token + "&task=list",
        "aoColumns": [
            { mData: mix },
    ...
    function mix(data, type, dataToSet) {
        var link = '<a href="procesos_editar.php?procesos_id=' + data.procesos_id + '"><img src="img/document.png" width="32"></a>';
        return link;
    }
...
function ayuda(){
    $.confirm({
        ...
        content: 'url:ayuda_procesos.html'
    });   	
}
</script>
        ...
        <div class="container-fluid p-4">
            ...
            <div class="row top-info-div">
                ...
                <div class="col text-end">
                    ...
                    <button onclick="window.location='procesos_editar.php?procesos_id=0'" type="button" class="btn btn-primary"><i class="fa-solid fa-plus"></i>&nbsp;Nuevo proceso</button>
                </div>                        
            </div>
