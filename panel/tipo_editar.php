...
$sql = "SELECT * FROM tipo WHERE id=" . mysqli_real_escape_string($db, $_GET['id']);
...
<title><?php echo $_GET["id"] == '0' ? 'Crear Nuevo Tipo' : 'Editar Tipo';?></title>
...
function generatePDF() {
    ...
    const opt = {
        margin: 1,
        filename: '<?php echo $row["tipo"] ?>.pdf',
    ...
    <div id="page-content-wrapper">
        <div class="container-fluid p-4">
            <div class="row top-info-div">
                <div class="col">
                    <h5><?php echo $_GET["id"] == '0' ? 'CREAR NUEVO TIPO' : 'EDITAR TIPO';?></h5>
                </div>
                <div class="col text-end">
                    <button onclick="window.location='tipo.php'" type="button" class="btn btn-primary"><i class="fa-solid fa-chevron-left"></i>&nbsp;Volver</button>
                </div>
            </div>
                ...
                <form id="form1" name="form1">
                    ...
                    <div class="row top-info-div">
                        ...
                        <div class="col" style="text-align:center">
                            <button id="btdelete" onclick="eliminar();" type="button" class="btn btn-danger"><i class="fa-regular fa-trash-can"></i>&nbsp;Eliminar tipo</button>
                        </div>
                        <?php } ?>
                        <div class="col" style="text-align:center">
                ...
                $.alert({
                    ...
                    buttons: {
                        confirm: {
                            ...
                            action: function(){
                                if (response != 0){
                                    window.location='tipo_editar.php?id='+response;
                                }
                            }
                        }
                    }
