...
$(document).ready(function() {
    ...
    var tabla = $('#tabla').DataTable({
        ...
        "sAjaxSource": "api/tipo.php?token=" + token + "&task=list",
        "aoColumns": [
            { mData: mix },
            { mData: 'tipo' }
        ],
    ...
    function mix(data, type, dataToSet) {
        var link = '<a href="tipo_editar.php?id=' + data.id + '"><img src="img/document.png" width="32"></a>';
        return link;
    }
        ...
        <div class="container-fluid p-4">
            ...
            <div class="row top-info-div">
                ...
                <div class="col text-end">
                    ...
                    <button onclick="window.location='tipo_editar.php?id=0'" type="button" class="btn btn-primary"><i class="fa-solid fa-plus"></i>&nbsp;Nuevo tipo</button>
                </div>                        
            </div>
