...
$(document).ready(function() {
    var tabla = $('#tabla').DataTable({
        ...
        "sAjaxSource": "api/sectores.php?token=" + $("#sid").val() + "&task=list",
        "aoColumns": [
            { mData: mix },
    ...
    function mix(data) {
        return '<a href="sectores_editar.php?sector_id=' + data.sector_id + '"><img src="img/document.png" width="32"></a>';
    }
});
</script>
</head>
        ...
        <div class="container-fluid p-4">
            ...
            <div class="row top-info-div">
                ...
                <div class="col text-end">
                    ...
                    <button onclick="window.location='sectores_editar.php?sector_id=0'" type="button" class="btn btn-primary"><i class="fa-solid fa-plus"></i>&nbsp;Nuevo sector</button>
                </div>
            </div>
