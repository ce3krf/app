...
// Fecha última actualización: 2025-09-19 12:17:23
// ************************************************************
...
$sql="select * from patentes where id=".$_GET['patentes_id'];
                ...
                <div class="row top-info-div">
                    <div class="col">
                      <?php if($_GET["proyectos_id"]=='0'){ ?>
                        <h5>CREAR NUEVA PATENTE</h5>
                      <?php } else { ?>
                        <h5>EDITAR PATENTE</h5>
                      <?php } ?>
                    </div>
                    ...
                    <button onclick="window.location='patentes.php'" type="button" class="btn btn-primary"><i class="fa-solid fa-chevron-left"></i>&nbsp;Volver</button>
                    <?php } else { ?>
                    <button onclick="window.location='patentes.php'" type="button" class="btn btn-primary"><i class="fa-solid fa-chevron-left"></i>&nbsp;Volver</button>                                          
                    <?php } ?>  
                    </div>                        
...
<div class="col">
 ...
 <div class="form-group">
  ...
  <input type="text" class="form-control" id="DIRECCION_COMERCIAL" name="DIRECCION_COMERCIAL" value="<?php echo $row["DIRECCION_COMERCIAL"];?>">
 </div>
...
<div class="col">
 ...
 <div class="form-group">
  <label for="ROL_PROP">ROL PROPIETARIO</label>
  <input type="text" class="form-control" id="ROL_PROP" name="ROL_PROP" value="<?php echo $row["ROL_PROP"];?>">
 </div>
...
<div class="col">
 ...
 <div class="form-group">
  ...
  <textarea class="form-control" id="GIRO" name="GIRO"><?php echo $row["GIRO"];?></textarea>
 </div>
...
<div class="col">
 ...
 <div class="form-group">
  <label for="TIPO_PATENTE">TIPO PATENTE</label>
  <input type="text" class="form-control" id="TIPO_PATENTE" name="TIPO_PATENTE" value="<?php echo $row["TIPO_PATENTE"];?>">
 </div>
...
<div class="col">
 ...
 <div class="form-group">
  ...
  <input type="text" class="form-control" id="LATITUD" name="LATITUD" value="<?php echo $row["LATITUD"];?>">
 </div>
...
<div class="col">
 ...
 <div class="form-group">
  ...
  <input type="text" class="form-control" id="LONGITUD" name="LONGITUD" value="<?php echo $row["LONGITUD"];?>">
 </div>
...
<input name="patentes_id" type="hidden" class="fields30" id="patentes_id" value="<?php echo $row["id"]?>" />
<input name="posted" type="hidden" class="fields30" id="posted" value="1" />
<?php if($_GET["patentes_id"]=='0'){ ?>
...
<div class="col">
  ...
  <?php if($row_tabla["usuarios_profile"] == 'ADMINISTRADOR'){ ?>
    <?php if($_GET["patentes_id"]=='0'){ ?>
    <?php } else { ?>
       <button id="btdelete" onclick="eliminar();" type="button" class="btn btn-danger"><i class="fa-regular fa-trash-can"></i>&nbsp;Eliminar patente</button>
       <?php } ?>
      </div>
...
<input type="hidden" class="form-control" id="patentes_id" name="patentes_id" value="<?php echo $row["id"];?>">
<input name="token" type="hidden" class="fields30" id="token" value="<?php echo $sid;?>" />
</form>
                ...
                $.alert({
                    ...
                    buttons: {
                      confirm: {
                        ...
                        action: function(){
                            if (response != 0){
                              window.location='patentes_editar.php?patentes_id='+response;
                            } else {
