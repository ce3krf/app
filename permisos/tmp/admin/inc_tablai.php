...
do {
    ...
    $sql = "select * from tablai where area='".$row_datos["area"]."' and tipo='".$row_datos["tipo"]."' ";
    //echo $sql."<br>";
    if(!$r = $db->query($sql)){
        die('Hay un error [' . $db->error . ']');
    }   
    ...
    $sql ="update tablai set ".$campo." ='".$valor."', ".$campo1."='".$row_datos["cuantos"]."' 
    , ".$campo0."='".$row_datos["suma"]."' where ";
