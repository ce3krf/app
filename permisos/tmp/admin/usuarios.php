...
$(document).ready(function() {
    ...
    "columnDefs": [
      ...
      { "targets": 5, visible:true, width: "10%" },
    ],


    "sAjaxSource": "api/usuarios.php?token="+token+"&task=list",
    "aoColumns": [
            { mData: mix } ,
...
function mix(data, type, dataToSet) {
    var encryptedId = encrypt(data.usuarios_id.toString());  // Encriptar el ID del usuario
    var link = '<a href="usuarios_editar.php?usuarios_id=' + encodeURIComponent(encryptedId) + '"><img src="../img/document.png" width="32"></a>';
    return link;
}  
        ...
        <?php include("sidebar.php");?>
            ...
            <main role="main" class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="row top-info-div">
                    ...
                    <button onclick="window.location='usuarios_editar.php?usuarios_id=0'" type="button" class="btn btn-primary"><i class="fa-solid fa-plus"></i></i>&nbsp;Nuevo usuario</button>
                    </div>                        
                </div>
